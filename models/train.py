...
def main(args):
    ...
    VAE1_model = VAE1(input_size=input_height * input_width, latent_size=1024)
    Translation_model = Translation(input_size=input_height * input_width, latent_size=1024)
    VAE2_model = VAE1(input_size=input_height * input_width, latent_size=1024)
    #Train VAE1
